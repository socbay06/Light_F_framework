...
void horn_schunck_warp_sor_view
(
        /*****************************************************/
        ...
        for(i=bx; i<nx+bx; i++)
                for(j=by; j<ny+by; j++)
                {
                        ...
                        du[i][j] = (1-omega) * du[i][j] + omega *
                                   ( ( J_12_s *dv[i][j] +J_13[i][j] +beta*t*t*u[i][j] -beta*s*t*v[i][j]
                                       - xm*( du[i-1][j] + u[i-1][j] )
                                       - xp*( du[i+1][j] + u[i+1][j] )
                                       - ym*( du[i][j-1] + u[i][j-1] )
                                       - yp*( du[i][j+1] + u[i][j+1] )
                        ...
                        dv[i][j] = (1-omega) * dv[i][j] + omega *
                                   ( ( J_12_s *du[i][j] +J_23[i][j] +beta*s*s*v[i][j] -beta*s*t*u[i][j]
                                       - xm*( dv[i-1][j] + v[i-1][j] )
                                       - xp*( dv[i+1][j] + v[i+1][j] )
                                       - ym*( dv[i][j-1] + v[i][j-1] )
                                       - yp*( dv[i][j+1] + v[i][j+1] )
...
void HORN_SCHUNCK_WARP_LEVEL_VIEW
(
        /*****************************************************/
        float **f1,     /* in     : 1st image                                */
        float **f2,     /* in     : 2nd image                                */
...
/* ---- perform SOR iterations ---- */
        for(i=1; i<=n_iter; i++)
        {
                horn_schunck_warp_sor_view(J_11, J_22, J_33, J_12, J_13, J_23,
                                      du, dv, u, v, nx, ny, bx, by, hx, hy,ns,nt,m_beta,
                                      m_alpha, n_omega);
        }
